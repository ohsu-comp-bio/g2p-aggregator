...
_EVIDENCE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='genes', full_name='ohsu.g2p.Evidence.genes', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='features', full_name='ohsu.g2p.Evidence.features', index=2,
...
_EVIDENCE.fields_by_name['features'].message_type = ga4gh_dot_sequence__annotations__pb2._FEATURE
