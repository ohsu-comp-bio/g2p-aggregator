...
sleep 5
python tagger.py --tag_property dev_tags --tag_name no-location --query "NOT _exists_:feature.start"
sleep 5
python tagger.py --tag_property dev_tags --tag_name no-biomarker_type --query "NOT _exists_:feature.biomarker_type"
